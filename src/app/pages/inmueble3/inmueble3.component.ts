...
@Component({
  selector: 'app-inmueble3',
  templateUrl: './inmueble3.component.html',
  styles: []
})
export class Inmueble3Component implements OnInit {
  ...
  this._inmuebleService.guardarInmueble(this.inmueble)
      .subscribe(inmueble => {
        ...
        this.inmueble._id = inmueble._id;
         ...
         this.router.navigate(['/inmueble3', inmueble._id]);
